...
int main(int argc, char** argv)
{
    ...
    ros::Publisher pubWaypointNodeEnded = n.advertise<std_msgs::Bool>("/caddy_bot/waypoint_following_status", 100);
    ...
    ros::param::get("/caddy_bot/coordinates_file", path_local);
